...
int main(int ac, char **av)
{
    ...
    if (strcmp(av[1], "branch") == 0 && ac == 2) {
        return cmd_list_branches();
    }
    if (strcmp(av[1], "diff") == 0 && ac == 3) {
        return cmd_diff(av[2]);
    }
    if (strcmp(av[1], "merge") == 0 && ac == 3) {
        return cmd_merge(av[2]);
    }
    if (strcmp(av[1], "reset") == 0 && ac == 2) {
        return cmd_reset();
    }
    if (strcmp(av[1], "graph") == 0 && ac == 2) {
        return cmd_graph();
    }
